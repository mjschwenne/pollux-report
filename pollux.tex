...
\begin{mathpar}
  ...
  \infer[Int-Chg-W]{v_2 = v_1 \mod 2^m}{v_1 : \mathtt{int[n]} \prec v_2 : \mathtt{int[m]}}

  \infer[Sint-Chg-W]{v_2 = v_1 \mod 2^m}{v_1 : \mathtt{sint[n]} \prec v_2 : \mathtt{sint[m]}}
  ...
  \infer[Int-Sint]
  {
    v_2 = \left\{
      {\begin{array}{l@{\quad:\quad}l}
        ...
        (-1)^{v_1} \times (v_1 + 2^{n-1}) - (v_1 \mod 2) & \text{otherwise}
      \end{array}}\right.
  }
  ...
  \infer[Sint-Int]
  {
    v_2 = \left\{
      {\begin{array}{l@{\quad:\quad}l}
        ...
        |2 \times v_1 - 2^{n-1}| - 2^{n-1} - \mathbb{1}[s < 2^{n-2}] & \text{otherwise}
      \end{array}}\right.
  }
