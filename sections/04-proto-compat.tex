...
\begin{mathpar}
  ...
  \infer[Field-Add]{id \not \in \textrm{ids}(f) }{\msg{s_m}{r}{f} \preceq
    \msg{s_m}{r}{(f \cup \{\field{s_f}{id}{\tau}\})}}
...
compatible. As a shorthand, I'll use $f_x$ to refer to the fields from the right
side of the conclusion of the rule annotated with the number $x$. I'm also
abusing map notation to update fields rather than heavy set notation. I'd like
to refactor this whole document to match that, with the fields being a map from
field ID number to a tuple containing the name and type.
\[
  \inferrule*[right=(6)]{
    \inferrule*[right=(5)]{
        \inferrule*[right=(4)]{
            \inferrule*[right=(3),vdots=1.5em,rightskip=7em]{
                \inferrule*[right=(2)]{
                    \inferrule*[right=(1)]{ 6 \not \in \mathrm{ids}(f) }{
                        \msg{\mathrm{Item}}{\varnothing}{f} \preceq \\\\
                        \msg{\mathrm{Item}}{\varnothing}{(f \cup \field{\mathrm{level}}{6}{\mathtt{int32}})}
                    }
                    8 \not \in \mathrm{ids}(f_1)
                }{
                    \msg{\mathrm{Item}}{\varnothing}{f_1} \preceq \\\\
                    \msg{\mathrm{Item}}{\varnothing}{(f_1 \cup \field{\mathrm{current\_loc}}{8}{\mathtt{Location}})}
                }
                7 \not \in \mathrm{ids}(f_2)
            }{
                \msg{\mathrm{Item}}{\varnothing}{f_2} \preceq \\\\
                \msg{\mathrm{Item}}{\varnothing}{(f_2 \cup \field{\mathrm{private\_description}}{8}{\mathtt{string}})}
            }
            \mathtt{int32} \propto \mathtt{int64}
        }{
            \msg{\mathrm{Item}}{\varnothing}{f_3} \preceq
            \msg{\mathrm{Item}}{\varnothing}{(f_3[4 \mapsto \field{\mathrm{value}}{4}{\mathtt{int64}}])}
        }
    }{
        \msg{\mathrm{Item}}{\varnothing}{f_4} \preceq
        \msg{\mathrm{Item}}{\varnothing}{(f_4[3 \mapsto \field{\mathrm{public\_description}}{3}{\mathtt{string}}])}
    }
  }{
    \msg{\mathrm{Item}}{\varnothing}{f_5} \preceq
    \msg{\mathrm{Item}}{\varnothing}{(f_5[5 \mapsto \field{\mathrm{origin\_loc}}{5}{\mathtt{Location}}])}
  }
\]
